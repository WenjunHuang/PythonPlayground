...
class ListBoxWindow(Gtk.Window):
    def __init__(self):
        ...
        listbox_2.set_sort_func(lambda row_1, row_2, data, notify_destroy: row_1.data.lower() > row_2.data.lower(),
                                None,
                                False)
        listbox_2.set_filter_func(lambda row, data, notify_destroy: False if row.data == 'Fail' else True,
                                  None,
                                  False)
